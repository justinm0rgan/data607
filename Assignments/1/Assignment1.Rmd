...
library(readr)
library(dplyr)
menSurvey <- read_csv("https://raw.githubusercontent.com/justinm0rgan/data607/main/Assignments/1/masculinity-survey/raw-responses.csv?token=GHSAT0AAAAAABPMFD5CF5TL7EW64ZZW3BYKYP6S5BQ", show_col_types = F,col_select = 2:98)
head(menSurvey)
```
