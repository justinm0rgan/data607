...
```{r split-boro-cd}
df_cd <- df_cd %>% 
  mutate(boro = substr(df_cd$boro_cd,1,1), 
         cd = substr(df_cd$boro_cd,2,3)) %>% 
...
So lets first focus on Council Districts.
